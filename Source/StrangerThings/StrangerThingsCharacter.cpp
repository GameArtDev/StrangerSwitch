...
AStrangerThingsCharacter::AStrangerThingsCharacter()
{
...
void AStrangerThingsCharacter::MoveRight(float Value)
{
...
void AStrangerThingsCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}
